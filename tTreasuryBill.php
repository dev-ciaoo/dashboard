      ...
      <div class="modal-body">
        ...
        <div class="mb-3 row">
          <label for="parValue" class="col-md-4 form-label"><strong>Par Value</strong></label>
            <div class="col-md-5">
              <input type="number" class="form-control" id="parValue" name="parValue" step="any" Required>
            </div>
        </div>
        <div class="mb-3 row">
          <label for="terms" class="col-md-4 form-label"><strong>Terms</strong></label>
            <div class="col-md-5">
        ...
        <div class="mb-3 row">
          <label for="bondsBank" class="col-md-3 form-label"><strong>Corporate Bonds</strong></label>
          <div class="col-md-1">
            <input type="checkbox" id="bondsCheck" name="bondsCheck" onchange="toggleBondsText()">
          </div>
            <div class="col-md-5">
              <input type="text" class="form-control" id="bondsBank" name="bondsBank" style="display: none;">
            </div>
        </div>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="mb-3 row">
          <label for="rparValue" class="col-md-4 form-label"><strong>Par Value</strong></label>
            <div class="col-md-5">
              <input type="number" class="form-control" id="rparValue" name="rparValue" step="any" Required>
            </div>
        </div>
        <div class="mb-3 row">
...
<script type="text/javascript">
    ...
    var mytable = $('#reporttbl').DataTable({
        ...
        "aoColumnDefs": [{
            "bSortable": false,
            "aTargets": [7] // Column index to disable sorting
        }],
...
<script>
  function toggleBondsText() {
    var bondsCheckbox = document.getElementById("bondsCheck");
    var bondsText = document.getElementById("bondsBank");

    if (bondsCheckbox.checked) {
        bondsText.disabled = false;
        bondsText.style.display = "block";
    } else {
        bondsText.disabled = true;
        bondsText.style.display = "none";
    }
  }
</script>
</body>
