...
<script src="js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        async function fetchVideoFiles() {
            try {
                const response = await fetch('./galleryGetVideos.php'); // Fetch file list from PHP
                ...
                videoFiles.forEach(file => {
                    photos.push(`./workshop/video/loans/${file}`);
                });
        ...
        if (photo.endsWith('.mp4') || photo.endsWith('.mov') || photo.endsWith('.MP4') || photo.endsWith('.MOV')) {
            anchor.addEventListener('click', function(event) {
                ...
                closeButton.addEventListener('click', () => {
                   window.location.href="galleryVideo.php";
                });
