...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top" id="topBar">
      ...
      <ul class="list-group">
        ...
        <div id="submenu2" class="collapse sidebar-submenu">
          ...
          <a data-toggle="collapse" data-target="#loanApplication" href="#loanApplication" aria-expanded="true"
            ...
            <span class="submenu-collapsed">• Memorandum Of Agreement</span>
            <?php
          ...
          <a data-toggle="collapse" data-target="#governID" href="#governID" aria-expanded="true" 
            ...
            <span class="submenu-collapsed">• Certification Of Employent</span>
            <?php
          ...
          <a data-toggle="collapse" data-target="#secRegistration" href="#secRegistration" aria-expanded="true" 
            ...
            <span class="submenu-collapsed">• Latest Payslip</span>
            <?php
          ...
          <a data-toggle="collapse" data-target="#GIS" href="#secRegistraGIStion" aria-expanded="true" 
            ...
            <span class="submenu-collapsed">• TIN / Any 2 Valid ID</span>
            <?php
            if(!empty($tin)){
              ?>
              <img src="./statusImage/check.png" id="statusImg" alt="">
          ...
          <a data-toggle="collapse" data-target="#boardReso" href="#boardReso" aria-expanded="true" 
            ...
            <span class="submenu-collapsed">• Brgy. Clearance For <br>&nbsp; Loan Purpose</span>
            <?php
        ...
        <a href="#submenu3" data-toggle="collapse" aria-expanded="false"
          ...
          <div class="d-flex w-100 justify-content-start align-items-center">
            <!-- <span class="fa fa-user fa-fw mr-3"></span> -->
            <span class="menu-collapsed"><b>CO-MAKER 1</b></span>
            <span class="submenu-icon ml-auto"></span>
          </div>
        </a>
        ...
        <div id="submenu3" class="collapse sidebar-submenu">
          ...
          <a data-toggle="collapse" data-target="#taxDecc" href="#taxDecc" aria-expanded="true"
            ...
            <span class="submenu-collapsed">• Valid ID With 3 Signature</span>
          ...
          <a data-toggle="collapse" data-target="#taxDecc2" href="#taxDecc2" aria-expanded="true" 
            ...
            <span class="submenu-collapsed" >• 3 Months Payslip</span>
            <?php
        ...
        <a href="#submenu4" data-toggle="collapse" aria-expanded="false"
          ...
          <div class="d-flex w-100 justify-content-start align-items-center">
            <!-- <span class="fa fa-user fa-fw mr-3"></span> -->
            <span class="menu-collapsed"><b>CO-MAKER 2</b></span>
            <span class="submenu-icon ml-auto"></span>
          </div>
        </a>
        ...
        <div id="submenu4" class="collapse sidebar-submenu">
          ...
          <a data-toggle="collapse" data-target="#AFS" href="#AFS" aria-expanded="true"
            ...
            <span class="submenu-collapsed">• Valid ID With 3 Signatures</span>
            <!-- <span style="font-size: 9px;">&nbsp;&nbsp;(1 COPY)</span> -->
            <?php
        ...
        <div id="submenu5" class="collapse sidebar-submenu">
          <a data-toggle="collapse" data-target="#AFR" href="#AFR" aria-expanded="true"
            ...
            <span class="submenu-collapsed">• Assignment Of Salary & Authority</span>
            <span class="submenu-collapsed">&nbsp;&nbsp;To Deduct & Remit</span>
            <?php
          ...
          <a data-toggle="collapse" data-target="#CIR" href="#CIR" aria-expanded="true"
            ...
            <span class="submenu-collapsed">• Financial Evaluation</span><br>
            <?php
            ...
            ?>
            <span style="font-size: 9px;">&nbsp;&nbsp;(CASHFLOW ANALYSIS)</span><br>
            <span class="submenu-collapsed">&nbsp;&nbsp;And BRR Scoreboard</span>
          </a>
          ...
          <a data-toggle="collapse" data-target="#CAR" href="#CAR" aria-expanded="true" 
            ...
            <span class="submenu-collapsed" >• Credit Information & Background</span>
          ...
          <a data-toggle="collapse" data-target="#AOVS" href="#AOVS" aria-expanded="true" 
            ...
            <span class="submenu-collapsed">• Affidavit Of Voluntary Surrender</span>
          </a>
          ...
          <a data-toggle="collapse" data-target="#BRRC" href="#BRRC" aria-expanded="true" 
            ...
            <span class="submenu-collapsed">• Borrower's Risk Rating</span>
            <span class="submenu-collapsed">&nbsp;&nbsp;/ Cashflow</span>
          </a> -->
        </div>
        ...
        <a href="#submenu10" data-toggle="collapse" aria-expanded="false"
          ...
          <div class="d-flex w-100 h-100 justify-content-start align-items-center">
            <!-- <span class="fa fa-user fa-fw mr-3"></span> -->
            <span class="menu-collapsed"><b>SIGNED DOCUMENS FOR LOAN RELEASE</b></span>
            <span class="submenu-icon ml-auto"></span>
          </div>
        </a>
  ...
  <script>
        const pdfUrl =  "<?php echo $memoAgreementS; ?>";
        const pdfUrl1 = "<?php echo $loanAppForm; ?>"
        const pdfUrl3 = '<?php echo $certofEmployment; ?>';
        const pdfUrl4 = '<?php echo $latestPayslip; ?>';
        const pdfUrl5 = '<?php echo $tin; ?>';
        const pdfUrl6 = '<?php echo $clearanceLoan; ?>';

        const pdfUrl8 = '<?php echo $coMaker1; ?>';
        const pdfUrl9 = '<?php echo $validSignatures; ?>';
        const pdfUrl10 = '<?php echo $monthsPayslip; ?>'; 

        const pdfUrl14 = '<?php echo $coMaker2; ?>';
        const pdfUrl15 = '<?php echo $validSignatures2; ?>';
        const pdfUrl16 = '<?php echo $latestPermit; ?>';
        const pdfUrl17 = '<?php echo $monthsPayslip2; ?>';
        ...
        const pdfUrl23 = '<?php echo $deductRemit; ?>';
        const pdfUrl24 = '<?php echo $cashflowScore; ?>';
        const pdfUrl25 = '<?php echo $loanAppMemo; ?>';
        ...
        const pdfUrl31 = '<?php echo $promissoryNoteS; ?>';
        const pdfUrl32 = '<?php echo $disclosureStateS; ?>';
        const pdfUrl33 = '<?php echo $mriForm; ?>';
        const pdfUrl34 = '<?php echo $amortScheduleS; ?>';
