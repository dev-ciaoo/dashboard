...
$sql = "SELECT * FROM disposal ORDER BY id DESC LIMIT 1";
  ...
  <div class="container-fluid">
    ...
    <div class="leave-form shadow-lg p-1 mb-4">
        ...
        <?php if($data == 0){
          ...
          <div class="postion-relative text-start text-uppercase">
                <?php 
                $stats = $data['stats'];
                if($stats == 0){
                    echo '
                            <h5>Status: 
                                <span class="badge bg-primary"> Waiting for Item Review</span>
                            </h5>
                        ';
                }else if($stats == 1){
                    echo '
                            <h5>Status: 
                                <span class="badge bg-primary"> Waiting for Item Bid</span>
                            </h5>
                        ';
                }else if($stats == 2){
                        echo '
                            <h5>Status: 
                                <span class="badge bg-primary"> Waiting for GM Approval</span>
                            </h5>
                        ';
                }else if($stats == 3){
                    echo '
                            <h5>Status: 
                                <span class="badge bg-success">Item is disposed successfully</span>
                            </h5>
                        ';
                }
                ?>
            ...
            <div class="col-md-5">
                ...
                <div class="position-relative">
                    ...
                    <input
                        ...
                        id="approvedBy"
                        class="form-control text-center text-uppercase pt-4"
                        value="<?= htmlspecialchars($data['approvedBy']); ?>"
                        readonly
                    >
                </div>
