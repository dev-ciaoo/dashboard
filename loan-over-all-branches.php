  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="dataTables_filter" id="btnAdd">
        <!-- <select class="form-control col-sm-3" name="loanCategory" id="loanCategory">
          ...
          <div class="col-md-12">
            ...
            <thead>
                ...
                <!-- <tr> -->
                  ...
                  <!-- INFORMATION columns -->
                  <th>Branch</th>
                  <th>Total Loan<br>Released</th>
                  <th>Past Due<br>Total</th>
                  <th>Past Due<br>Ratio</th>
                  <th>REM: Individual</th>
                  <th>REM: Corporation</th>
                  <th>Salary</th>
                  <th>OUR Bank Employee Loan</th>
                  <th>Microfinance</th>
                  <th>Hold-Out</th>
                  <th>End Buyer</th>
                  <th>Small Scale</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        'order': [],
        'ajax': {
          'url': 'fetch-loan-overall-report.php',
          'type': 'post',
        },
        // "aoColumnDefs": [{  
        //     "bSortable": false,
        ...
        // ]
        'columnDefs': [
          { "orderable": true, "targets": [0, 1, 2, 4, 5, 6, 7, 8, 9, 10, 11, 12] },
