        ...
        <form action="" method="post" name="formReport" id="formReport">
          ...
          <div class="form-group">
            <select class="form-control" name="loanCategory" id="loanCategory" Required>
              <option value="Salary" disabled selected>Salary Loan</option>
          ...
          <div class="col-md-12">
            ...
            <thead>
                ...
                <!-- <tr> -->
                  ...
                  <th>Memorandum Of <br>Agreement</th>
                  <th>Certificate Of <br>Employment</th>
                  <th>Latest Payslip</th>
                  <th>Valid ID</th>
                  <th>Brgy. Clearance<br>(For Loan Purposes)</th>

                  <th>Co-Maker 1<br>Statement</th>
                  <th>Valid ID<br>(3 Signatures)</th>
                  <th>Payslip<br>(3 Months)</th>

                  <th>Co-Maker 2<br>Statement</th>
                  <th>Valid ID<br>(3 Signatures)</th>
                  <th>Payslip<br>(3 Months)</th>

                  <th>Assignment Of Salary And To Deduct And Remit</th>
                  <th>Financial Evaluation (BRR/Cashflow)</th>
                  <th>Loan Approval Memo</th>
                  ...
                  <th>Nakasula Na Kapasyahan</th>
                  <th>Office Of Brgy. Resolution</th>
                  <th>Canvass Of Votes</th>
                  <th>Oath Of Office</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        'order': [],
        'ajax': {
          'url': 'fetch_lmsReport-salary.php',
          'type': 'post',
        },
        // "aoColumnDefs": [{  
        //     "bSortable": false,
