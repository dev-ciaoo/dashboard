...
$sql = "SELECT * FROM disposal WHERE stats = 1 ORDER BY id DESC LIMIT 1";
        ...
        <?php if($data == 0){
          ...
          <span id="dateToday">Date: 
            ...
            <div class="col-md-9">
                ...
                <div class="form-floating">
                    <?php
                        $appraisalName = $data['appraiserName'];
                    ?>
                    <!-- <input type="text" name="iAppraiser" id="iAppraiser" class="form-control" placeholder=" " value="$_SESSION['fullname'];" required> -->
                    <input type="text" name="iAppraiser" id="iAppraiser" class="form-control" value="<?= htmlspecialchars($appraisalName); ?>" readonly>
            ...
            <div class="col-md-3">
                ...
                <div class="form-floating">
                    <input type="text" name="iDateAppraisal" id="iDateAppraisal" placeholder=" " class="form-control" value="<?= date('F j, Y', strtotime($data['appraisalDate'])); ?>" readonly>
            ...
            <div class="col-md-3">
                <div class="form-floating">
                    <input type="text" name="iAppraisalVal" id="iAppraisalVal" class="form-control" placeholder=" " value="<?= number_format($data['appraisalVal'], 2, '.', ','); ?>" readonly>
                    <small class="text-muted text-start d-flex">Enter amount in &#x20B1;</small>
            ...
            <div class="col-md-12 semi-header" id="semi-header">
                ...
                <input type="hidden" name="bidEmpUserId" id="bidEmpUserId">
                <input type="hidden" name="bidEmpId" id="bidEmpId">
                <input type="hidden" name="bidEmpName" id="bidEmpName">
            </div>
            <div class="col-md-6">
                <br>
                <div class="form-floating">
                    <!-- <input type="text" name="iBidderName" id="iBidderName" class="form-control" placeholder=" " required> -->
                     <select name="iBidderName" id="iBidderName" class="form-select" required>
            ...
            <div class="col-md-3">
                ...
                <div class="form-floating">
                    <input type="date" name="iStartBidding" id="iStartBidding" placeholder=" " class="form-control" required>
            ...
            <div class="col-md-3">
                ...
                <div class="form-floating">
                    <input type="date" name="iEndBidding" id="iEndBidding" placeholder=" " class="form-control" required>
            ...
            <div class="col-md-9">
                <div class="form-floating">
                    <textarea name="iBiddingAddress" id="iBiddingAddress" class="form-control" rows="4" placeholder=" " required></textarea>
                    <label for="iBiddingAddress" class="form-label">BIDDER ADDRESS</label>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-floating">
                    <input type="text" name="iBidAmount" id="iBidAmount" placeholder=" " class="form-control" required>
                    <small class="text-muted text-start d-flex">Enter amount in &#x20B1;</small>
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" name="iBiddingContact" id="iBiddingContact" class="form-control" placeholder=" " required>
                    <label for="iBiddingContact" class="form-label">BIDDER CONTACT NUMBER</label>
                </div>
                </br>
            </div>
            <div class="col-md-3">
                <div class="form-floating" style="display: <?= ($fetchEmp['userId'] == 123) ? 'block' : 'none'; ?>;">
                    <input type="text" name="bidRemarks" id="bidRemarks" class="form-control" placeholder=" ">
                    <label for="bidRemarks" class="form-label">REMARKS</label>
                </div>
                </br>
            </div>
            <div class="col-md-9">
                <div class="form-floating">
                    <input type="date" name="iDateAward" id="iDateAward" class="form-control" placeholder=" " required>
            ...
            <div class="col-md-3">
                <div class="form-floating">
                    <input type="text" name="iCertSale" id="iCertSale" placeholder=" " class="form-control" required>
            ...
            <div class="col-md-9">
                <div class="form-floating">
                    <input type="date" name="iReleaseDate" id="iReleaseDate" class="form-control" placeholder=" " required>
            ...
            <div class="col-md-3">
                <div class="form-floating">
                    <input type="text" name="iOR" id="iOR" placeholder=" " class="form-control" required>
            ...
            <div class="col-md-5">
                ...
                <input type="text" name="biddedBy" id="biddedBy" class="form-control text-center text-uppercase d-flex pt-4" value="<?php echo $_SESSION['fullname']; ?>" readonly>
                <span class="text-muted text-center">Signature Over Printed Name</span>
            </div>

            <div class="col-md-5">
                <?php
                    $dateTime = $data['reviewedDate'];
                    $parts = explode("@", $dateTime);
                    $dateOnly = trim($parts[0]);
                ?>
                ...
                <div class="position-relative">
                    ...
                    <input
                        ...
                        id="reviewedBy"
                        class="form-control text-center text-uppercase pt-4"
                        value="<?= htmlspecialchars($data['reviewedBy']); ?>"
                        readonly
                    >
                </div>
            ...
            <!-- <div class="col-md-5">
                ...
                <input type="text" name="reviewedBy" id="reviewedBy" class="form-control text-center text-uppercase d-flex pt-4" value="<?= $data['reviewedBy']; ?>" readonly>
                <span class="text-muted text-center">Signature Over Printed Name</span>
            </div> -->
            <div class="col-md-2"></div>
            <div class="col-md-5">
                <label for="" class="text-start d-flex"><h5 class="p-1">Approved By:</h5></label>
                <input type="text" name="approvedBy" id="approvedBy" class="form-control text-center text-uppercase d-flex pt-4" value="" readonly>
                <span class="text-muted text-center">Signature Over Printed Name</span>
            </div>
...
$(document).on('change', '#iBidderName', function(e) {
    ...
    if(userId == 123){
        $('#bidRemarks').parent().show();
    }else{
        $('#bidRemarks').parent().hide();
        $('#bidRemarks').val('');
    }
