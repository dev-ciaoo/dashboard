...
$sql = "SELECT * FROM disposal WHERE stats = 2 ORDER BY id DESC LIMIT 1";
          ...
          <span id="dateToday">Date: 
            ...
            <div class="col-md-9">
                ...
                <div class="form-floating">
                    ...
                    <input type="text" name="iAppraiser" id="iAppraiser" class="form-control" value="<?= $data['appraiserName']; ?>" readonly>
            ...
            <div class="col-md-6">
                <br>
                <div class="form-floating">
                    <input type="text" name="iBidderName" id="iBidderName" class="form-control" placeholder=" " value="<?= $data['bidderName']; ?>" readonly>
            ...
            <div class="col-md-3">
                ...
                <div class="form-floating">
                    <input type="text" name="iStartBidding" id="iStartBidding" placeholder=" " class="form-control" value="<?= date('F j, Y', strtotime($data['bidStartDate'])); ?>" readonly>
            ...
            <div class="col-md-3">
                ...
                <div class="form-floating">
                    <input type="text" name="iEndBidding" id="iEndBidding" placeholder=" " class="form-control" value="<?= date('F j, Y', strtotime($data['bidEndDate'])); ?>" readonly>
            ...
            <div class="col-md-9">
                <div class="form-floating">
                    <?php
                        $addresss = $data['bidderAddress'];
                    ?>
                    <textarea name="iBiddingAddress" id="iBiddingAddress" class="form-control" rows="4" placeholder=" " readonly><?= htmlspecialchars($addresss); ?></textarea>
            ...
            <div class="col-md-3">
                <div class="form-floating">
                    <input type="text" name="iBidAmount" id="iBidAmount" placeholder=" " class="form-control" value="<?= number_format($data['bidAmount'], 2, '.', ','); ?>" readonly>
                    <small class="text-muted text-start d-flex">Enter amount in &#x20B1;</small>
            ...
            <div class="col-md-9">
                <div class="form-floating">
                    <input type="text" name="iBiddingContact" id="iBiddingContact" class="form-control" placeholder=" " value="<?= $data['bidderContact']; ?>" readonly>
            ...
            <div class="col-md-9">
                <div class="form-floating">
                    <input type="text" name="iDateAward" id="iDateAward" class="form-control" placeholder=" " value="<?= date('F j, Y', strtotime($data['dateAward'])); ?>"  readonly>
            ...
            <div class="col-md-3">
                <div class="form-floating">
                    <input type="text" name="iCertSale" id="iCertSale" placeholder=" " class="form-control" value="<?= $data['certSale']; ?>" readonly>
            ...
            <div class="col-md-9">
                <div class="form-floating">
                    <input type="text" name="iReleaseDate" id="iReleaseDate" class="form-control" placeholder=" " value="<?= date('F j, Y', strtotime($data['dateAward'])); ?>" readonly>
            ...
            <div class="col-md-3">
                <div class="form-floating">
                    <input type="text" name="iOR" id="iOR" placeholder=" " class="form-control" value="<?= $data['orNumber']; ?>" readonly>
            ...
            <div class="col-md-5">
                ...
                <div class="position-relative">
                    ...
                    <input
                        ...
                        id="biddedBy"
                        class="form-control text-center text-uppercase pt-4"
                        value="<?= htmlspecialchars($data['biddedBy']); ?>"
                        readonly
                    >
                </div>
            ...
            <!-- <div class="col-md-5">
                <?php
                    // This is for removal of @ up to time. sample @ 10:51 AM
                    $approveDatee =    $dateTimee = $approvedDate;
                                        $partss = explode("@", $dateTimee);
                                        $dateOnlyy = trim($partss[0]);

                ?>
                <label for="" class="text-start d-flex"><h5 class="p-1">Approved Date:</h5></label>
                <input type="text" name="approvedDate" id="approvedDate" class="form-control text-center pt-4" value="<?= $dateOnlyy; ?>" readonly>
            </div> -->
            <div class="col-md-5">
                <label for="" class="text-start d-flex"><h5 class="p-1">Approved By:</h5>
                ...
                <input type="text" name="approvedBy" id="approvedBy" class="form-control text-center text-uppercase d-flex pt-4" value="<?php echo $_SESSION['fullname']; ?>" readonly>
