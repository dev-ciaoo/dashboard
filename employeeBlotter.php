...
<meta charset="utf-8">
  ...
  <title>OUR Bank Blotter Tab</title>
...
/* @media screen and (max-width: 2133.33px) {
    ...
    td span {
      ...
      text-align: left;      /* text starts at left inside the inline-block */
      max-width: 500px;      /* keep a readable width */
    }
...
$(document).ready(function() {
  ...
  function downloadFile(id, fileName) {
    window.location.href = "blotterFile.php?id=" + id + "&fileName=" + encodeURIComponent(fileName);
  }
