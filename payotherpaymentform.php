...
<div class="container">
    <form id="myform" method="post" action="payotherpayment.php">
        <input type="hidden" name="id" value="">
        <div class="d-flex flex-column gap-3">
            <div class="input-group">
                <span class="input-group-text">Employee ID</span>
                <input  placeholder="Input Employee ID" value="" required class="form-control" name="empid" id="empid" type="number">
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input placeholder="Input Amount" require value="" required class="form-control" name="otherpayment" id="otherpayment" type="number">
            </div>
            <div class="input-group">
                <span class="input-group-text">Remarks</span>
                <input placeholder="Input Remarks" require value="" required class="form-control" name="remarks" id="remarks" type="text">
            </div>
            <div class="input-group">
