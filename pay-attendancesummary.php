      ...
      <div class="payslip-form">
        <div class="align-items-center justify-content-center form-floating inputFields">
            <div  class="mb-2 input-group form-floating inputFields">
                <select  name="selectDate" id="selectDate" class="d-flex text-center align-items-center justify-content-center form-control" aria-describedby="button-addon2">
            ...
            <select style="padding-right:120px;" name="Category" id="Category" class="mb-2 d-flex text-center align-items-center justify-content-center form-control">
              <option value="" selected disabled>-- Select Category --</option>
              <option value="Late">Late</option>
              <option value="Absent">Absent</option>
            </select>   
            <select style="padding-right:120px;" name="Sorting" id="Sorting" class="mb-2 d-flex text-center align-items-center justify-content-center form-control">
...
window.location.href = "pay-reportsalary.php";   

});

$('#Sorting').change(function() {
    if(valcategory == 'Absent'){
        submitDataAbsent();
    }else{
        submitDataLate();
    }
