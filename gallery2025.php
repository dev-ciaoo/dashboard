...
<body>
    <h1><b>2025 Christmas Party Photo Gallery</b></h1>
    ...
    <script>
        ...
        async function fetchPhotoFiles() {
            try {
                const response = await fetch('./galleryGetGal2025.php'); // Fetch file list from PHP
                ...
                photoFiles.forEach(file => {
                    photos.push(`./workshop/xmas2025/${file}`);
                });
