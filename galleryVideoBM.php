...
<div class="forVUpload">
    ...
    <h1><b></b>BM & Department Heads Workshop</b></h1>
...
<script src="js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        async function fetchVideoFiles() {
            try {
                const response = await fetch('./galleryGetVideosBM.php'); // Fetch file list from PHP
                ...
                videoFiles.forEach(file => {
                    photos.push(`./workshop/video/bms/${file}`);
                });
        ...
        if (photo.endsWith('.mp4') || photo.endsWith('.mov') || photo.endsWith('.MP4') || photo.endsWith('.MOV')) {
            anchor.addEventListener('click', function(event) {
                ...
                closeButton.addEventListener('click', () => {
                   window.location.href="galleryVideoBM.php";
                });
    ...
    .then(data => {
        if (data.success) {
            ...
            data.uploadedFiles.forEach(file => {
                photos.push('./workshop/video/bms/' + file); // Add uploaded videos to the photos array
            });
