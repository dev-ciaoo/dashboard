        ...
        <form action="" method="post" name="formReport" id="formReport">
          ...
          <div class="form-group">
            <select class="form-control" name="loanCategory" id="loanCategory" Required>
              ...
              <option value="REM: Corporation" disabled selected>REM: Corporation</option>
          ...
          <div class="col-md-12">
            ...
            <thead>
                ...
                <!-- <tr> -->
                  ...
                  <th>Government Valid ID<br>Of Representative of Loan<br>(Photocopy w/ 3 Signature)</th>
                  <th>Photocopy Of SEC<br>Registration Article Of <br>Incorporation AND By-Laws</th>
                  <th>Photocopy Of Latest<br>General Inforation Sheet<br>(GIS)</th>
                  <th>Original Copy Of Board Resolution<br>And Secretary's Certificate</th>
                  <th>Government ID Of Corporate Secretary<br>(Photocopy w/ 3 Signature)</th>

                  <th>Transfer Certificate Title<br>(Original & Certified True Copy)</th>
                  ...
                  <th>Updated Business Permit<br>(Mayor, Brgy., AND/OR DTI)</th>
                  <th>Latest 3 Years Audited<br>Financial Statement</th>
                  <th>Latest 3 Years In-House<br>Financial Statement</th>
                  <th>Business Latest Bank Statement(Atleast 6 Months)</th>
                  <th>Income Tax Return(If Applicable)</th>
                  <th>Contract Of Lease</th>
                  <th>5 Customers With Contact Number</th>
                  <th>5 Suppliers With Contact Number</th>
                  <th>Proof Of Billing(If Applicable)</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        'order': [],
        'ajax': {
          'url': 'fetch_lmsReport-corporation.php',
          'type': 'post',
        },
        // "aoColumnDefs": [{  
        //     "bSortable": false,
...
<script>
  $(document).ready(function(){
    $(document).on('click', '.refresh', function(e){
      e.preventDefault();
      var href = "lms-corporation-report.php";
