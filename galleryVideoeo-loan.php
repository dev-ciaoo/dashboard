...
<div class="forVUpload">
    ...
    <h1><b></b>Employee and Officer Loan Workshop</b></h1>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <script>
        ...
        async function fetchVideoFiles() {
            try {
                const response = await fetch('./galleryGetVideoseo-loan.php'); // Fetch file list from PHP
                ...
                videoFiles.forEach(file => {
                    photos.push(`./workshop/video/eo-loan/${file}`);
                });
        ...
        if (photo.endsWith('.mp4') || photo.endsWith('.mov') || photo.endsWith('.MP4') || photo.endsWith('.MOV')) {
            anchor.addEventListener('click', function(event) {
                ...
                closeButton.addEventListener('click', () => {
                   window.location.href="galleryVideoeo-loan.php";
                });
...
<script>
   document.getElementById('videoUpload').addEventListener('change', () => {
    ...
    fetch('galleryFileUploadeo-loan.php', {
        method: 'POST',
        body: formData
    })
    ...
    .then(data => {
        if (data.success) {
            ...
            data.uploadedFiles.forEach(file => {
                photos.push('./workshop/video/eo-loan/' + file); // Add uploaded videos to the photos array
            });
